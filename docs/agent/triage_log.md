...
Active findings after dedup:
  ADVISORY | TEST | mvn verify | Validation performance summary reported 1 warning | HASH:86103a35
  MINOR | STYLE | src/main/java/org/Aayush/routing/execution/ExecutionProfileRegistry.java:[58] | LineLength: Line is longer than 80 characters (found 84). | HASH:16d1e5f9
  MINOR | STYLE | docs/agent/.scan_cycle81_java_static.log | 10551 additional Checkstyle violations remain in Java static analysis output (see log for line-level details) | HASH:919715d2
...
Active findings after dedup:
  ADVISORY | TEST | mvn verify | Validation performance summary reported 1 warning | HASH:86103a35
  MINOR | STYLE | src/main/java/org/Aayush/routing/execution/ExecutionProfileRegistry.java:[49] | LineLength: Line is longer than 80 characters (found 103). | HASH:af51655f
  MINOR | STYLE | docs/agent/.scan_cycle80_java_static.log | 10552 additional Checkstyle violations remain in Java static analysis output (see log for line-level details) | HASH:d353b13e
...
Active findings after dedup:
  ADVISORY | TEST | mvn verify | Validation performance summary reported 1 warning | HASH:86103a35
  MINOR | STYLE | src/main/java/org/Aayush/routing/execution/ExecutionProfileRegistry.java:[46] | LineLength: Line is longer than 80 characters (found 96). | HASH:b8cb7aa2
  MINOR | STYLE | docs/agent/.scan_cycle79_java_static.log | 10553 additional Checkstyle violations remain in Java static analysis output (see log for line-level details) | HASH:14c623b2
