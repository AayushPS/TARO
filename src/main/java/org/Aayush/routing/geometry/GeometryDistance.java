...
/**
 * Shared numeric helpers for geometry distance computations.
 *
 * <p>This utility is used by both heuristic providers and Stage 15 addressing
 * normalization to keep Euclidean and spherical distance semantics aligned.</p>
 */
@UtilityClass
public final class GeometryDistance {
     ...
     */
    public static double greatCircleDistanceMeters(double lat1Deg, double lon1Deg, double lat2Deg, double lon2Deg) {
     ...
     */
    public static double normalizeDeltaLongitudeDegrees(double deltaLonDeg) {
