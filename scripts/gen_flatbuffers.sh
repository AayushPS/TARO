...
JAVA_OUT_FINAL="${ROOT_DIR}/src/main/java/org/Aayush/flatbuffers"
...
# Rewrite Java package and relocate into org/Aayush/flatbuffers
...
for f in "${taro_java_dir}"/*.java; do
  ...
  sed \
    -e 's/^package taro\.model;/package org.Aayush.flatbuffers.taro.model;/' \
    -e 's/\btaro\.model\./org.Aayush.flatbuffers.taro.model./g' \
